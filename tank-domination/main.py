...
game_tank_svg_sprite = pygame.transform.scale(game_tank_svg,(75,75))
...
game_characteristics = {
    ...
    "player": {
     ...
     "cpu": {
        "position": {
            "x": 0.8 * monitor_display[0] - game_tank_svg_sprite.get_width()
        },
        "hp": 1
    }
}
...
while game_running_flag:
    ...
    game_display.blit(game_tank_sprite_cpu,(game_characteristics["player"]["position"]["x"], game_characteristics["grass"]["position"]["y"] - game_tank_sprite_cpu.get_height()))
